...
export function NewHabitForm() {
  ...
  async function createNewHabit(evemt: FormEvent) {
  ...
  function handleToggleeekDay(weekDay: number) {
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <div className="mt-3 flex flex-col gap-2">
        {availableWeekDays.map((weekDay, index) => (
          <Checkbox.Root
            ...
            onCheckedChange={() => handleToggleeekDay(index)}
          >
      ...
      <button
        type="submit"
        className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-600 hover:bg-green-500 transition-colors focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zin-900"
